...
class LiqPay(object):
    FORM_TEMPLATE = u'''\
<form id="liqpay_form" method="post" action="{action}" accept-charset="utf-8">
\t{param_inputs}
    <input id="id_submit" type="image" src="//static.liqpay.com/buttons/p1{language}.radius.png" name="btn_text" />
</form>'''
    INPUT_TEMPLATE = u'<input id="id_{name}" type="hidden" name="{name}" value="{value}"/>'
