    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', models.DecimalField(default=0, verbose_name='balance', max_digits=20, decimal_places=2, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(related_name='courses_course', verbose_name='course', to='courses.Course')),
                ('user', models.ForeignKey(related_name='users_course', verbose_name='user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
